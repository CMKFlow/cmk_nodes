...
const CMK_NODE_CLASS = "CMK_ImageQuickMetrics";
const CMK_DISPLAY_NAME = "CMK Image QuickMetrics";
...
function attachInstanceHandler(node) {
    if (!isQuickMetrics(node) || node.__cmkQuickMetricsPatched) return;
    node.__cmkQuickMetricsPatched = true;
...
app.registerExtension({
    name: "cmk.image.quickmetrics.widgets.v27_24",
